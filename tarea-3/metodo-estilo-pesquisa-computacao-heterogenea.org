#+TITLE: Metodo de Pesquisa e Estilo de Pesquisa
#+AUTHOR: Fabricio Puente Mansilla
#+EMAIL: fpuentem@usp.br
#+DATE: <2025-09-30 Tue>

* Estilo de Pesquisa e Nível de Maturidade

** Estilo de Pesquisa (Tipos de Pesquisa, Cap. 4.2)
...
** Nível de Maturidade Científica (Cap. 5)
...
* Rigor Metodológico: Definições Operacionais e Variáveis
...
** Definição Operacional da Eficiência Energética
